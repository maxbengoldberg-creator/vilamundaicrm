...
export const STAGES = ['qualif', 'apres', 'quente', 'negociacao', 'contrato', 'assinatura', 'pagamento', 'ganho', 'sem_datas', 'reveillon', 'lead_site', 'reservas_2027', 'reserva_ruim', 'grupo_grande', 'morno'];
